...
public class TwoColumn_ListAdapter extends ArrayAdapter<Quote> {

    private LayoutInflater mInflater;
    private ArrayList<Quote> quotes;
    private int mViewResourceId;

    public TwoColumn_ListAdapter(Context context, int textViewResourceId, ArrayList<Quote> quotes) {
